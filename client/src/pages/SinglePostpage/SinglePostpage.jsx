...
const SinglePostPage = () => {
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            onClick={async () => {
              const response = await fetch(`https://blogg-xs4m.onrender.com/post/${id}`, {
                method: "DELETE",
                credentials: "include",
              });
  ...
  return (
    <div className="max-w-7xl mx-auto mt-10 p-6 lg:p-12 bg-white rounded-xl shadow-lg">
      <Toaster position="top-right" />
      {/* Title Above the Image */}
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">{postInfo.title}</h1>
      ...
      {/* Post Info */}
      <div className="flex flex-col md:flex-row justify-between items-center text-gray-600 mb-8">
